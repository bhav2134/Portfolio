  ...
  return (
    <div id="about" className='about'>
      <Fade triggerOnce direction='up' duration={1200}>
        ...
        <span className='uni'> Toronto Metropolitan University (Formerly known as Ryerson Univeristy) </span>, focused on mastering full-stack development with a specialization in <span className='career-choices'> Artificial Intelligence and Data Engineering</span>. When I'm not at my computer, I love lifting weights, playing the guitar, cycle down mountainous terrains, playing video games, go on challenging hikes, or reading fiction books. 
        </p>
